      ...
      <div className="flex flex-wrap justify-center gap-3 mx-auto w-11/12 my-10">
        <div className="card bg-primary text-primary-content w-96">
          <div className="card-body">
            ...
            <p>
              Good serverices are the foundation of a successful business. They
              help to build trust and loyalty with customers, and they can also
        ...
        <div className="card bg-primary text-primary-content w-96">
          <div className="card-body">
            <h2 className="card-title">Greate</h2>
            <p>
              Great services go above and beyond to meet the needs of customers.
              They are attentive, responsive, and proactive in addressing
              customer concerns.
            </p>
            <div className="card-actions justify-end">
              <a href="/services">
        ...
        <div className="card bg-primary text-primary-content w-96">
          <div className="card-body">
            ...
            <p>
              Premium services offer the highest level of quality and attention
              to detail. They are designed for customers who demand the best and
        ...
        <div className="card w-96 bg-base-100 shadow-sm">
          <div className="card-body">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-xl">$31/mo</span>
            </div>
            <ul className="mt-6 flex flex-col gap-2 text-xs">
              <li>
                <svg
